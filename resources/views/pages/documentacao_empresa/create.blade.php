<x-app-layout>
    <div class="flex justify-center items-center min-h-screen mt-6">
        <div class="max-w-full w-full bg-white shadow-md rounded-lg p-6">
            ...
            <form action="{{ route('verificacao_empresa.store') }}" method="POST">
                ...
                <!-- Prefeitura -->
                <div class="mb-6">
                    <h3 class="text-lg font-semibold text-gray-800 mb-4">Prefeitura</h3>
                ...
                <!-- Bombeiro -->
                <div class="mb-6">
                        <h3 class="text-lg font-semibold text-gray-800 mb-4">Bombeiro</h3>
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-2">
                            <div>
                ...
                <!-- Vigilância -->
                <div class="mb-6">
                    <h3 class="text-lg font-semibold text-gray-800 mb-4">Vigilância</h3>
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-2">
                        <div>
                ...
                <div class="mb-6">
                    <h3 class="text-lg font-semibold text-gray-800 mb-4">Funcionamento</h3>
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-2">
                        <div>
